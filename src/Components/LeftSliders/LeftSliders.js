    ...
    return (
        <div className='hidden lg:flex fixed flex-col top-[34%] left-0 z-20'>
            <ul className='container_links_nav'>
                <li className="small_container px-2 w-[150px] h-[60px] left_menu_container bg-blue-600 flex items-center gap-4 text-[20px]">
                    <a href="https://www.linkedin.com/in/yakkkot" target="_blank" className='flex items-center justify-between w-full'>LinkedIn
                        <FaLinkedin color={'white'} size={30}/>
                    </a>
                </li>
                <li className="small_container px-2 w-[150px] h-[60px] left_menu_container bg-gray-700 flex items-center gap-4 text-[20px]">
                    <a href="https://github.com/yakkkot" target="_blank" className='flex items-center justify-between w-full'>GitHub
                        <FaGithub color={'white'} size={30}/>
                    </a>
                </li>
                <li className="small_container px-2 w-[150px] h-[60px] left_menu_container bg-blue-500 flex items-center gap-4 text-[20px]">
                ...
                <li className="small_container px-2 w-[150px] h-[60px] left_menu_container bg-violet-700 flex items-center gap-4 text-[20px]">
